            ...
            <div key={risk.id} className="rounded border border-gray-700 bg-gray-800 p-5 shadow-sm transition-colors hover:border-gray-600">
              ...
              {risk.file && (
                <Link
                  ...
                  className="mt-3 flex items-center gap-1.5 text-sm text-gray-400 font-mono bg-gray-900 px-3 py-1.5 rounded hover:text-accent hover:bg-gray-900/80 transition-colors self-start w-fit"
                >
