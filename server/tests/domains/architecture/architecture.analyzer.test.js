const { buildArchitectureModel } = require('../../../src/domains/architecture/architecture.analyzer');
const { generateSystemOverview } = require('../../../src/domains/architecture/mermaid.generator');
