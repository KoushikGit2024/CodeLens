const { buildRefactoringIntelligence, calculatePriority } = require('../../../src/domains/engineering/refactoring.analyzer');
const { SEVERITY, RISK_CATEGORIES } = require('../../../src/domains/engineering/risk.analyzer');
