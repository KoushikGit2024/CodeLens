...
const store    = require('../../../src/domains/repository/repository.store');
const { generateAnswer, isProviderConfigured } = require('../../../src/core/ai/aiProvider');
...
describe('POST /api/repository/:id/ask — AI provider errors', () => {
  ...
  test('ProviderUnavailableError returns 503', async () => {
    const { ProviderUnavailableError } = require('../../../src/core/ai/aiProvider');
    isProviderConfigured.mockReturnValue(true);
